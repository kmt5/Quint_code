...
//データベースに接続(test3)
    ...
    $volid = "SELECT * FROM volunteers WHERE vol_id in (SELECT vol_id FROM sanka_situations where s_user_id = '1234567a' and favo_flag = 1)";
    ...
    foreach ($result as $row) {
      ...
      //echo '<br>';
      echo '<button class="del">お気に入り解除</button>';
      echo '<br>';
      echo '</div>';
      }
